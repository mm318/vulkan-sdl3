...
pub const vk = struct {
    ...
    pub const SAMPLER_MIPMAP_MODE_NEAREST = c.VK_SAMPLER_MIPMAP_MODE_NEAREST;
    ...
    pub const BORDER_COLOR_FLOAT_TRANSPARENT_BLACK = c.VK_BORDER_COLOR_FLOAT_TRANSPARENT_BLACK;
    pub const BORDER_COLOR_INT_TRANSPARENT_BLACK = c.VK_BORDER_COLOR_INT_TRANSPARENT_BLACK;
    pub const BORDER_COLOR_FLOAT_OPAQUE_BLACK = c.VK_BORDER_COLOR_FLOAT_OPAQUE_BLACK;
    pub const BORDER_COLOR_INT_OPAQUE_BLACK = c.VK_BORDER_COLOR_INT_OPAQUE_BLACK;
    pub const BORDER_COLOR_FLOAT_OPAQUE_WHITE = c.VK_BORDER_COLOR_FLOAT_OPAQUE_WHITE;
    ...
    pub const BLEND_FACTOR_SRC_COLOR = c.VK_BLEND_FACTOR_SRC_COLOR;
    pub const BLEND_FACTOR_ONE_MINUS_SRC_COLOR = c.VK_BLEND_FACTOR_ONE_MINUS_SRC_COLOR;
    pub const BLEND_FACTOR_DST_COLOR = c.VK_BLEND_FACTOR_DST_COLOR;
    pub const BLEND_FACTOR_ONE_MINUS_DST_COLOR = c.VK_BLEND_FACTOR_ONE_MINUS_DST_COLOR;
    ...
    pub const BLEND_FACTOR_DST_ALPHA = c.VK_BLEND_FACTOR_DST_ALPHA;
    pub const BLEND_FACTOR_ONE_MINUS_DST_ALPHA = c.VK_BLEND_FACTOR_ONE_MINUS_DST_ALPHA;
    pub const BLEND_FACTOR_CONSTANT_COLOR = c.VK_BLEND_FACTOR_CONSTANT_COLOR;
    pub const BLEND_FACTOR_ONE_MINUS_CONSTANT_COLOR = c.VK_BLEND_FACTOR_ONE_MINUS_CONSTANT_COLOR;
    pub const BLEND_FACTOR_CONSTANT_ALPHA = c.VK_BLEND_FACTOR_CONSTANT_ALPHA;
    pub const BLEND_FACTOR_ONE_MINUS_CONSTANT_ALPHA = c.VK_BLEND_FACTOR_ONE_MINUS_CONSTANT_ALPHA;
    pub const BLEND_FACTOR_SRC_ALPHA_SATURATE = c.VK_BLEND_FACTOR_SRC_ALPHA_SATURATE;
    pub const BLEND_FACTOR_SRC1_COLOR = c.VK_BLEND_FACTOR_SRC1_COLOR;
    pub const BLEND_FACTOR_ONE_MINUS_SRC1_COLOR = c.VK_BLEND_FACTOR_ONE_MINUS_SRC1_COLOR;
    pub const BLEND_FACTOR_SRC1_ALPHA = c.VK_BLEND_FACTOR_SRC1_ALPHA;
    pub const BLEND_FACTOR_ONE_MINUS_SRC1_ALPHA = c.VK_BLEND_FACTOR_ONE_MINUS_SRC1_ALPHA;
    pub const BLEND_OP_ADD = c.VK_BLEND_OP_ADD;
    pub const BLEND_OP_SUBTRACT = c.VK_BLEND_OP_SUBTRACT;
    pub const BLEND_OP_REVERSE_SUBTRACT = c.VK_BLEND_OP_REVERSE_SUBTRACT;
    pub const BLEND_OP_MIN = c.VK_BLEND_OP_MIN;
    pub const BLEND_OP_MAX = c.VK_BLEND_OP_MAX;
    ...
    pub const PIPELINE_STAGE_HOST_BIT = c.VK_PIPELINE_STAGE_HOST_BIT;
...
pub const SDL = struct {
    ...
    pub const SYSTEM_THEME_DARK = c.SDL_SYSTEM_THEME_DARK;
    pub const SYSTEM_THEME_LIGHT = c.SDL_SYSTEM_THEME_LIGHT;
